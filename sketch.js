...
mainCyclist.setCollider("rectangle", 0, 0, 40, 100);
...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    function keyPressed() {
      // Se a tecla "R" for pressionada e o jogo estiver no estado END, chame a função reset()
...
//criar função reset aqui
 if (gameState === END) {
  ...
  // Adicione o texto "Pressione R para reiniciar" aqui
  textSize(20);
  fill(255);
  text("Pressione R para reiniciar", 550, 200);

  // Se a tecla "R" for pressionada, chame a função reset()
